...
<body>
    ...
    <main class="main-content">
        <div class="car-image-container">
            <img src="assets/lexus.jpg" alt="Ford Raptor Ranger">
        </div>

        <div class="car-details">
            <h2>LEXUS LFA</h2>
            <p>
A rare Japanese supercar with a high-revving V10 and a legendary exhaust note. Known for its craftsmanship, precision engineering, and exclusivity.
